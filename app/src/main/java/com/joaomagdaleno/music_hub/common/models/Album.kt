 ...
 * @property isRadioSupported Whether the album can be used to create a radio
 * @property isFollowable Whether the album can be followed
 * @property isSaveable Whether the album can be saved to library
 * @property isLikeable Whether the album can be liked
 * @property isHideable Whether the album can be hidden
 * @property isShareable Whether the album can be shared
 */
@Serializable
data class Album(
