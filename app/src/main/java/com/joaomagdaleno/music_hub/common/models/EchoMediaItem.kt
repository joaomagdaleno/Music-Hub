 ...
 * @property isFollowable Whether the media item can be followed
 * @property isSaveable Whether the media item can be saved to library
 * @property isLikeable Whether the media item can be liked
 * @property isHideable Whether the media item can be hidden
 * @property isRadioSupported Whether the media item can be loaded to get [Radio]
 * @property isShareable Whether the media item can be shared
 *
 * @see Track
 * @see Artist
 * @see User
